...
<h1>
    <?php
        echo "Certificados em Andamento $nome"
    ?>
</h1>
<?php
        $result_relatorio="
        ...
        *
        from
            ...
            select a1.*,
                ...
                ) as status_certificado
                from
                certificado as a1
                where a1.usuario_cod_usuario =$cod_usuario
            ) as t1
        where status_certificado in ('Criado','Aprovado pela Coordenação', 'Aprovado pela Secretaria');";
        ...
        echo "Status: " . $row_relatorio['status_certificado'] . "<br><hr>";
